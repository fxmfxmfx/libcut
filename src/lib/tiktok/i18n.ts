...
const en: Dict = {
  ...
  "player.comments.slow": "Loading takes ~30s (headless browser required for TikTok comment API)",
...
const ru: Dict = {
  ...
  "player.comments.slow": "Загрузка занимает ~30 сек (нужен headless браузер для comment API TikTok)",
